...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      'Founded and scaled a semester-based book rental service for university students.',
      'Managed procurement, pricing, logistics, and customer operations independently.',
      'Handled orders, inventory, and returns, with payments processed via bKash.',
      'Grew the service using a Facebook page as the central communication and sales platform.',
      'Led a three-person team handling delivery, logistics, and branding.'
    ],
  },
  {
